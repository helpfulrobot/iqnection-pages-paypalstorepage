<?php
	...
	class PaypalItemOption extends DataObject
	{
	    ...
	    public function validate()
	    {
	        ...
	        if (DataObject::get_one('PaypalStoreItem', "ItemID = '".$this->ItemID."'")) {
	            $result->error('Item Number must be unique');
	        }
	        if (DataObject::get_one('PaypalItemOption', "ItemID = '".$this->ItemID."'".$extra)) {
	            $result->error('Item Number must be unique');
	        }
	        return $result;
	    }
	...
	class PaypalStoreItem extends DataObject
	{
	    ...
	    public function validate()
	    {
	        $result = parent::validate();
	        $extra = ($this->ID) ? " AND ID <> ".$this->ID : null;
	        if (DataObject::get_one('PaypalStoreItem', "ItemID = '".$this->ItemID."'".$extra)) {
	            $result->error('Item Number must be unique');
	        }
	        if (DataObject::get_one('PaypalItemOption', "ItemID = '".$this->ItemID."'")) {
	            $result->error('Item Number must be unique');
	        }
	        return $result;
	    }
	...
	{
	    public static $icon = "iq-paypalstorepage/images/icon-paypalstorepage";
	...
	class PaypalStorePage_Controller extends Page_Controller
	{
	    ...
	    public function process_ipn_response($request=null)
	    {
